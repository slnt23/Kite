...
└── .docs/
    ├── PROJECT.md             # 项目架构文档【文档】
    ├── ROOT_FILES.md          # 根目录文件说明【文档】
    ├── ARCHITECTURE.md        # 项目架构概览【文档】
    └── FRONTEND_API_NORMS.md  # 前端接口与数据规范【文档】
```
