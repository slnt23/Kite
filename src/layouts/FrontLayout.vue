...
import menuImageStory from '../assets/front/pic01.jpg'
import menuImageCapabilities from '../assets/front/pic02.jpg'
import menuImageLogin from '../assets/front/pic03.jpg'
...
const menuItems = [
  ...
  {
    title: '登录入口',
    subtitle: '预留给后续后台或账号体系接入',
    path: '/login',
    image: menuImageLogin,
  },
]
  ...
  <div class="site-shell" :class="{ 'site-shell--menu-open': menuOpen }">
    ...
    >
      ...
      <div class="site-header__actions">
        ...
        <RouterLink class="site-header__button site-header__button--login" to="/login">
          登录
        </RouterLink>
      </div>
    </header>
