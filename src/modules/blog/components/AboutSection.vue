  ...
  <section class="about-section">
    ...
    <div class="about-header">
      <div class="avatar-wrapper">
        <img
          class="avatar"
          src="https://neeko-copilot.bytedance.net/api/text2image?prompt=anime%20style%20portrait%20of%20a%20young%20man%20with%20black%20hair%20and%20glasses%2C%20wearing%20formal%20attire%2C%20soft%20lighting%2C%20professional%20headshot&size=512x512"
          alt="Arthals"
        />
      </div>
      <h1 class="name">Arthals</h1>
      <div class="location-row">
        ...
        <a href="https://github.com" target="_blank" class="location-item github-link">
          <svg class="icon" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- Two-column: About label | content -->
    <div class="about-body">
      <div class="section-label">
        <h2>About</h2>
      </div>
      <div class="section-content">
        <p class="tag-line">Developer / Designer / <del>Medical student</del></p>
        <div class="bio-text">
          <p>你好，我叫 Arthals，是一个兴趣使然、热爱编程的医学生。</p>
          <p>
            目前就读于北京大学医学部，同时修读计算机科学技术双学位。一边被
            <del>病理病生药理</del> 内外妇儿折磨，一边在
            <del>ICS 的 Lab 作业</del> PyTorch 中 debug 到头秃。
          </p>
          <p>我即将在北京大学先进制造与机器人学院攻读博士学位。</p>
          <p>我的兴趣主要在 Large Language Model / Embodied AI 方向。</p>
          <p>我喜欢 Minecraft。</p>
        </div>
